<!--仓库管理系统首页组件-->
<template>
    <el-container style="height: 100%; border: 1px solid #eee; background-color:#F7FAF8;">
        ...
        methods:{
            doCollapse(){
                ...
                if(!this.isCollapse){// 展开
                    ...
                    this.icon='iconfont icon-r-left'
                }else{//关起、关闭、收起
                    this.aside_witdh='64px'
                    this.icon='iconfont icon-r-right'
                }
            }
        }
    }
